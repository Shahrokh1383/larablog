...
test('deletes all profiles for given user id', function () {
    $user1 = User::factory()->create();
    $user2 = User::factory()->create();

    $profile1 = Profile::factory()->create(['user_id' => $user1->id]);
    $profile2 = Profile::factory()->create(['user_id' => $user1->id]);
    $profile3 = Profile::factory()->create(['user_id' => $user2->id]);
    ...
    $this->assertDatabaseMissing('profiles', ['id' => $profile2->id]);
    $this->assertDatabaseHas('profiles', ['id' => $profile3->id]);
});