...
class TaxonomyServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->bind(CategoryPublicServiceInterface::class, CategoryPublicService::class);
        $this->app->bind(TagPublicServiceInterface::class, TagPublicService::class);
        
        $this->app->bind(CategoryAdminServiceInterface::class, CategoryService::class);
        $this->app->bind(TagAdminServiceInterface::class, TagService::class);
    }
