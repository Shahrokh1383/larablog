    ...
    <section className="taxonomy-hero">
      ...
      <div className="container">
        <div className="taxonomy-hero-content">
          <span className="taxonomy-hero-icon"><i className="fa-sharp fa-solid fa-layer-group"></i></span>
          <h1 className="taxonomy-hero-title">Browse by <span className="text-gradient">Category</span></h1>
          <p className="taxonomy-hero-desc">
            Explore all categories and find exactly what you are looking for. Click any category to see related articles.
          </p>
